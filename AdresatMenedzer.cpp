...
void AdresatMenedzer::podajIdOstatniegoAdresataPoUsunieciuWybranegoAdresata(int idUsunietegoAdresata) {
    plikZAdresatami.ustawIdOstatniegoAdresata(plikZAdresatami.podajIdOstatniegoAdresataPoUsunieciuWybranegoAdresata(idUsunietegoAdresata, plikZAdresatami.pobierzIdOstatniegoAdresata()));
}
